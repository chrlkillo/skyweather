...
async def get_weather():
    ...
    async with httpx.AsyncClient() as client:
        r = await client.get("https://api.open-meteo.com/v1/forecast", params={
            "latitude": LAT,
            "longitude": LON,
            "hourly": "temperature_2m,rain,cloud_cover,cloud_cover_low,cloud_cover_mid,wind_speed_10m,wind_speed_100m,wind_speed_200m,wind_gusts_10m",
            "models": "ecmwf_ifs",
...
def _parse_open_meteo(raw):
    ...
    for i, t in enumerate(times):
        ...
        wind100 = hourly["wind_speed_100m"][i] or 0
