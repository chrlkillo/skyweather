...
SOUNDTRACKS = {
    ...
    "perfect": [
        ...
        ("Twisted Transistor", "Korn", "https://youtu.be/KwgvGkuUDHU"),
        ("Point Break skydive", "Point Break", "https://youtu.be/R2nDaG0szGc"),
        ("Point Break freefall", "Point Break", "https://youtu.be/Q9g7sBVUFMs"),
    ],
}
