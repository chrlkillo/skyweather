...
# Цитаты дня — случайные, не привязаны к погоде
DAILY_QUOTES = [
    "Купол раскрылся — значит день удался",
    "Инструктор говорит всё будет хорошо — он так всегда говорит",
    "Выпрыгнул первым — очередь не занимал",
    "Самолёт набирает высоту — время вспомнить зачем пришёл",
    "Первый раз всегда страшно — потом просто страшно",
    "Прыгаешь сам — значит сам и виноват",
    "Посмотрел вниз — зря",
    "Купол открылся — ты снова веришь в людей",
    "Я вишенка на этом торте",
    "Вышел из зоны комфорта",
    "Повторяй что всё хорошо — особенно в свободном падении",
    "Между прыгнуть и не прыгнуть — выбор только один",
    "План один — купол. План два — тоже купол",
    "Никаких гарантий — кроме пожизненных",
    "План Б универсальный — адреналин и пофигизм",
    "О вкусах не спорят — и особенно на высоте четыре тысячи",
    "Думай позитивно — стакан всегда наполовину полон. Повторяй даже если звучит странно",
    "Мой плейлист всегда чист — мои мысли на высоте тоже",
    "Никаких гарантий кроме пожизненных — никакой славы кроме прижизненной",
    "Не делай прыжок — а если да — делай уверенно",
]
...
SOUNDTRACKS = {
    "sunny": [
        ("Here Comes The Sun", "The Beatles", "https://youtu.be/KQetemT1sWc", "Солнце пришло — и всё хорошо"),
        ("Walking on Sunshine", "Katrina & The Waves", "https://youtu.be/iPUmE-tne5U", "Иду по солнцу — и чувствую себя хорошо"),
        ("Good Day Sunshine", "The Beatles", "https://youtu.be/4o_C-YXmFgk", "Хороший день, солнечный день"),
        ("Sun Is Shining", "Bob Marley", "https://youtu.be/fbJOmxpkFhY", "Солнце светит — время веселиться"),
        ("Lovely Day", "Bill Withers", "https://youtu.be/bEeaS6fuUoA", "Посмотри на день — какой прекрасный"),
    ],
    "cloudy": [
        ("The Sound of Silence", "Simon & Garfunkel", "https://youtu.be/4zLfCnGVeL4", "Привет, тьма, мой старый друг"),
        ("Riders on the Storm", "The Doors", "https://youtu.be/iv8GW1GaoIc", "Всадники в шторм — в мир рождённые"),
        ("November Rain", "Guns N Roses", "https://youtu.be/8SbUC-UaAxE", "Ничто не длится вечно — даже холодный ноябрьский дождь"),
        ("Cloud 9", "George Harrison", "https://youtu.be/8EK4fKMzXuA", "На девятом облаке — выше всех"),
        ("Both Sides Now", "Joni Mitchell", "https://youtu.be/Pbn6a0AFtgM", "Облака смотрел я с обеих сторон"),
    ],
    "rainy": [
        ("Purple Rain", "Prince", "https://youtu.be/TvnYmWpD_T8", "Никогда не значит вечно — под пурпурным дождём"),
        ("Raindrops Keep Fallin", "BJ Thomas", "https://youtu.be/OHhNZakuOLk", "Капли дождя всё падают на голову — но не сдамся"),
        ("Have You Ever Seen The Rain", "CCR", "https://youtu.be/Gu2pVPWGYMQ", "Видел ли ты дождь в солнечный день"),
        ("Rain", "The Beatles", "https://youtu.be/tHbe4J3fJkE", "Дождь — если дождь придёт, спрячусь в тени"),
        ("Singing in the Rain", "Gene Kelly", "https://youtu.be/D1ZYhVpdXbQ", "Пою под дождём — какое чудесное чувство"),
    ],
    "windy": [
        ("Blowin in the Wind", "Bob Dylan", "https://youtu.be/vWwgrjjIMXA", "Сколько раз взлетит человек — прежде чем его назовут свободным"),
        ("Dust in the Wind", "Kansas", "https://youtu.be/tH2w6Oxx0kQ", "Всё что мы делаем — пыль на ветру"),
        ("Wind of Change", "Scorpions", "https://youtu.be/n4RjJKxsamQ", "Ветер перемен дует прямо в лицо"),
        ("Gone with the Wind", "Jimmy Dorsey", "https://youtu.be/qDc3K4V-2EM", "Унесено ветром"),
        ("The Wind Cries Mary", "Jimi Hendrix", "https://youtu.be/6EEW-9NDM5k", "И ветер кричит — свободен"),
    ],
    "perfect": [
        ("Free Fallin", "Tom Petty", "https://youtu.be/1lWJXDG2i0A", "Я в свободном падении — да, в свободном падении"),
        ("Jump", "Van Halen", "https://youtu.be/SwYN7mTi6HM", "Прыгай — давай прыгай"),
        ("Learn to Fly", "Foo Fighters", "https://youtu.be/1VQ_3sBZEm0", "Мне нужно научиться летать — выбраться отсюда"),
        ("Sky is the Limit", "Biggie", "https://youtu.be/Bm1n_JnkXnk", "Небо — это предел"),
        ("Fly Away", "Lenny Kravitz", "https://youtu.be/l_mynKNOeJo", "Хочу улететь отсюда — далеко"),
        ("Twisted Transistor", "Korn", "https://youtu.be/KwgvGkuUDHU", "Слышишь этот звук — он ведёт тебя вверх"),
        ("Point Break skydive", "Point Break", "https://youtu.be/R2nDaG0szGc", "Это лучшее чувство в мире — адреналин"),
        ("Point Break freefall", "Point Break", "https://youtu.be/Q9g7sBVUFMs", "Сто процентов чистого адреналина"),
        ("Danger Zone", "Kenny Loggins", "https://youtu.be/siwpn14IE7E", "Шоссе в опасную зону"),
        ("Highway to Hell", "AC/DC", "https://youtu.be/l482T0yNkeo", "На шоссе в ад — и мне нравится"),
        ("Enter Sandman", "Metallica", "https://youtu.be/CD-E-LDc384", "Выключи свет — и прыгни"),
        ("Back in Black", "AC/DC", "https://youtu.be/pAgnJDJN4VA", "Вернулся — в чёрном"),
        ("Eye of the Tiger", "Survivor", "https://youtu.be/btPJPFnesV4", "Взгляд тигра — дух выжившего"),
        ("Thunderstruck", "AC/DC", "https://youtu.be/v2AC41dglnM", "Громом поражён — в небе"),
        ("Rock You Like a Hurricane", "Scorpions", "https://youtu.be/6yP1tcy9a10", "Налечу на тебя как ураган"),
        ("Bohemian Rhapsody", "Queen", "https://youtu.be/fJ9rUzIMcZQ", "Я просто бедный парень — мне не нужно сочувствие"),
        ("Песня о друге", "Высоцкий", "https://youtu.be/RW17SlgsG2Y", "Если друг оказался вдруг — и не друг, и не враг, а так"),
        ("Если друг оказался вдруг", "Высоцкий", "https://youtu.be/UOeiJLpu_Ck", "Парня в горы тяни — рискни"),
        ("Кони привередливые", "Высоцкий", "https://youtu.be/99WmTK-lw1M", "Чуть помедленнее кони — чуть помедленнее"),
        ("Я люблю тебя жизнь", "Марк Бернес", "https://youtu.be/eGu_lVnCyAg", "Я люблю тебя жизнь — и надеюсь что это взаимно"),
    ],
}
...
def get_daily_soundtrack(weather_data):
    ...
    track = tracks[idx]
    name, artist, url = track[0], track[1], track[2]
    quote = track[3] if len(track) > 3 else ""
    return mood, name, artist, url, quote
...
async def get_jumprun_weather():
    """Получает ветра по высотам через GFS для команды /jumprun."""
    params = [
        ...
        ("hourly", "wind_speed_120m"), ("hourly", "wind_direction_120m"),
        ("hourly", "wind_speed_975hPa"), ("hourly", "wind_direction_975hPa"),
        ("hourly", "wind_speed_925hPa"), ("hourly", "wind_direction_925hPa"),
        ("hourly", "wind_speed_900hPa"), ("hourly", "wind_direction_900hPa"),
        ("hourly", "wind_speed_850hPa"), ("hourly", "wind_direction_850hPa"),
        ("hourly", "wind_speed_800hPa"), ("hourly", "wind_direction_800hPa"),
        ("hourly", "wind_speed_700hPa"), ("hourly", "wind_direction_700hPa"),
        ("hourly", "wind_speed_600hPa"), ("hourly", "wind_direction_600hPa"),
    ]
    async with httpx.AsyncClient() as client:
        for attempt in range(3):
            try:
                r = await client.get("https://api.open-meteo.com/v1/forecast", params=params, timeout=20)
        ...
        for i, t in enumerate(times):
            ...
            items.append({
                ...
                "wind": {
                    "speed":     round(gv("wind_speed_10m", i), 1),
                    "deg":       round(gv("wind_direction_10m", i)),
                    "speed_100m":round(gv("wind_speed_120m", i), 1),
                    "deg_120m":  round(gv("wind_direction_120m", i)),
                    "w975": round(gv("wind_speed_975hPa", i), 1), "d975": round(gv("wind_direction_975hPa", i)),
                    "w925": round(gv("wind_speed_925hPa", i), 1), "d925": round(gv("wind_direction_925hPa", i)),
                    "w900": round(gv("wind_speed_900hPa", i), 1), "d900": round(gv("wind_direction_900hPa", i)),
                    "w850": round(gv("wind_speed_850hPa", i), 1), "d850": round(gv("wind_direction_850hPa", i)),
                    "w800": round(gv("wind_speed_800hPa", i), 1), "d800": round(gv("wind_direction_800hPa", i)),
                    "w700": round(gv("wind_speed_700hPa", i), 1), "d700": round(gv("wind_direction_700hPa", i)),
                    "w600": round(gv("wind_speed_600hPa", i), 1), "d600": round(gv("wind_direction_600hPa", i)),
                },
            })
        return items
...
async def get_weather_raw():
    """Debug — возвращает сырые данные GFS."""
    async with httpx.AsyncClient() as client:
        r = await client.get("https://api.open-meteo.com/v1/forecast", params={
            "latitude": LAT, "longitude": LON,
            "hourly": "wind_speed_600hPa,wind_direction_600hPa,wind_speed_700hPa,wind_direction_700hPa,wind_speed_925hPa,wind_direction_925hPa",
            "models": "gfs_seamless", "timezone": "Europe/Moscow", "wind_speed_unit": "ms", "forecast_days": 1,
        }, timeout=10)
        data = r.json()
        hourly = data.get("hourly", {})
        return {"gfs": {k: hourly[k][12] for k in hourly if k != "time"}}


async def get_weather():
    """Получает погоду с Open-Meteo, модель ECMWF IFS. 3 попытки."""
    params = {
        "latitude": LAT,
        "longitude": LON,
        "hourly": "temperature_2m,rain,cloud_cover,cloud_cover_low,cloud_cover_mid,wind_speed_10m,wind_speed_120m,wind_gusts_10m,wind_direction_10m,wind_direction_120m",
        "models": "ecmwf_ifs",
        "timezone": "Europe/Moscow",
        "wind_speed_unit": "ms",
        "forecast_days": 3,
    ...
    last_error = None
    servers = ["https://api.open-meteo.com/v1/forecast", "https://api.open-meteo.com/v1/forecast"]
    for url in servers:
        for attempt in range(2):
            try:
                async with httpx.AsyncClient() as client:
                    ...
                    if r.status_code == 200 and r.text.strip():
                        return _parse_open_meteo(r.json())
                    last_error = f"HTTP {r.status_code}"
            except Exception as e:
                last_error = str(e)
            await asyncio.sleep(3)
    raise Exception(f"Сервер погоды недоступен: {last_error}")
...
def _parse_open_meteo(raw):
    ...
    for i, t in enumerate(times):
        ...
        # Pressure levels
        def gw(key):
            """Берёт значение поля, ищет ближайший ненулевой если текущий None/0."""
            arr = hourly.get(key)
            if arr is None:
                return 0
            val = arr[i]
            ...
            for offset in range(1, 4):
                for idx in [i - offset, i + offset]:
                    if 0 <= idx < len(arr) and arr[idx] is not None and arr[idx] != 0:
                        return arr[idx]
            return 0
...
def calc_aff_prob(fl):
    ...
    for item in fl:
        ...
        # Ветер у земли >8 м/с — запрет
        w10 = item["wind"]["speed"]
        if w10 > 8:
            scores.append(0)
            continue

        # Ветер на 120м >13 м/с — запрет
        w120 = item["wind"].get("speed_100m", 0)
        if w120 > 13:
            scores.append(0)
            continue

        # Облачность — те же штрафы что у опытных
        c = item["clouds"]["all"]
        if c > 80: s -= 40
        elif c > 65: s -= 25
        elif c > 45: s -= 10
...
def calc_jumprun(items_now):
    ...
    cp_layers = [
        (" 800м", w.get("w925",0), w.get("d925",0), 10),   # купол высоко
        (" 320м", w.get("w975",0), w.get("d975",0), 10),   # купол средне
        (" 100м", w["speed_100m"], w.get("deg_120m",0), 10), # купол низко
        ("Земля", w["speed"],      w.get("deg",0),     10),  # финал
    ]
    ...
    # Определяем куда сносит относительно курса самолёта
    # approach_deg — курс самолёта (против ветра на 4200м)
    approach_deg_calc = round(w.get("d600", 0))
    # Угол между сносом и курсом самолёта
    angle_diff = (drift_deg - approach_deg_calc + 360) % 360

    # Если снос идёт примерно по курсу самолёта (±90°) — сносит вперёд → выброска ДО точки
    # Если снос идёт против курса (90°-270°) — сносит назад → выброска ЗА точкой
    if angle_diff <= 90 or angle_diff >= 270:
        # Снос по направлению полёта — выброска до точки
        position = "до точки"
    else:
        # Снос против направления полёта — выброска за точкой
        position = "за точкой"

    # +500м поправка для середины группы (линия выброски)
    adjusted = total + 500

    if adjusted < 650:
        offset = "0м — выброска над точкой"
    elif adjusted < 1100:
        offset = f"500м {position}"
    elif adjusted < 1350:
        offset = f"700м {position}"
    elif adjusted < 1700:
        offset = f"1000м {position}"
    elif adjusted < 2000:
        offset = f"1500м {position}"
    else:
        offset = f"2000м {position}"
    ...
    approach_deg = round(w.get("d600", 0))  # самолёт летит против ветра = курсом откуда дует ветер
...
def format_jumprun(jr, today_fl):
    ...
    return (
        ...
        f"🎯 Выброска: {jr['offset']}\n"
        f"✈️ Курс самолёта: {jr['approach_deg']}° (против ветра {jr['w_exit']:.1f} м/с на 4200м)\n\n"
...
async def make_message(label):
    ...
    _, s_name, s_artist, s_url, s_quote = get_daily_soundtrack(data)
            ...
            for update in data.get("result", []):
                ...
                if text == "/start":
                    ...
                    await tg_send(
                        ...
                        "Команды:\n"
                        "/weather — прогноз и вероятности прыжков\n"
                        "/jumprun — ветра по высотам и точка выброски\n"
                        "\n"
                        "Показывает вероятности прыжков для AFF студентов 🎓",
                        chat_id=user_chat_id
                    )
                elif text == "/ping" and str(user_chat_id) == str(CHAT_ID):
                    results = []
                    urls = [
                        "https://api.open-meteo.com/v1/forecast?latitude=54.32&longitude=40.88&hourly=temperature_2m&models=gfs_seamless&forecast_days=1",
                        "https://api.open-meteo.com/v1/forecast?latitude=54.32&longitude=40.88&hourly=temperature_2m&models=ecmwf_ifs&forecast_days=1",
                    ...
                    async with httpx.AsyncClient() as client:
                        for url in urls:
                            try:
                                ...
                                results.append(f"{'✅' if r.status_code==200 else '❌'} {r.status_code} {ms}мс — {url[:50]}")
                            except Exception as e:
                                results.append(f"❌ Ошибка — {url[:50]}\n   {str(e)[:80]}")
                    await tg_send("🔍 Диагностика:\n\n" + "\n".join(results), chat_id=user_chat_id)
                elif text == "/jumprun_debug" and str(user_chat_id) == str(CHAT_ID):
                    try:
                        results = await get_weather_raw()
                        msg = "Тест моделей (i=12):\n\n"
                        for model, sample in results.items():
                            msg += f"{model}:\n"
                            for k, v in sample.items():
                                msg += f"  {k}: {v}\n"
                            msg += "\n"
                        await tg_send(msg, chat_id=user_chat_id)
                    except Exception as e:
                        await tg_send(f"Debug error: {e}", chat_id=user_chat_id)
                elif text == "/jumprun":
                    try:
                        now_msk = datetime.now(tz=MSK)
                        today = now_msk.date()
                        # GFS данные по высотам для jumprun
                        jr_items = await get_jumprun_weather()
                        now_items = [i for i in jr_items
                                     if datetime.fromtimestamp(i["dt"], tz=MSK).hour == now_msk.hour
                                     and datetime.fromtimestamp(i["dt"], tz=MSK).date() == today]
                        if not now_items:
                            now_items = [jr_items[0]]
                        # ECMWF данные для облачности
                        wx_data = await get_weather()
                        today_fl = [i for i in wx_data["list"]
                    ...
                    await tg_send(
                        "📋 Проверка NOTAMов и запретов воздушного пространства:\n\n"
                        "https://fpln.ru\n\n"
                        "Введи ICAO код аэродрома: UUWR (Рязань)",
                        chat_id=user_chat_id
                    )
                elif text == "/weather":
                    stats["requests"] += 1
